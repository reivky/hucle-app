...
@section('content')
    <main class="col-span-10 bg-slate-100 dark:bg-gray-900 min-h-[100vh] pb-10">
        <div
            ...
            <h3 class="block bold text-xl dark:text-white">Karyawan</h3>
            <ol class="list-reset flex">
                <li class="text-gray-500 dark:text-white">Master Data / Karyawan</li>
            </ol>
        </div>
            ...
            <div class="flex justify-between w-full px-2 py-2 bg-white dark:bg-gray-800">
                <button data-bs-toggle="modal" data-bs-target="#modalTambah"
                    class="rounded-lg px-4 py-2 text-white bg-green-500 hover:bg-green-600"><i
                        class="fal fa-plus mr-3"></i>Tambah Karyawan
                </button>
                            ...
                            <table class="min-w-full shadow-md">
                                <thead class="bg-white border-b dark:bg-gray-800 dark:border-gray-900">
                                    <tr>
                                        ...
                                        <th scope="col"
                                            class="text-sm text-center font-medium text-gray-900 px-6 py-4 border-r dark:text-white dark:border-gray-900">
                                            Aksi
                                        </th>
                                    </tr>
                                </thead>
                                    ...
                                    @foreach ($karyawans as $data)
                                        <tr
                                            ...
                                            <td
                                                ...
                                                {{ $loop->iteration + $karyawans->firstItem() - 1 }}
                                            </td>
                                            <td
                ...
                <form action="/karyawan" method="POST">
                    ...
                    <div class="modal-body relative p-4">
                        <div class="form-group mb-6">
                            <label for="nama" class="form-label inline-block mb-2 text-gray-700 dark:text-white">Nama
                                Karyawan</label>
                            <input type="text"
                                class="form-control
                           block
                           ...
                           focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                id="nama" name="nama" placeholder="nama karyawan" required>
                        </div>
                        <div class="form-group mb-6">
                            <label for="jabatan"
                                class="form-label inline-block mb-2 text-gray-700 dark:text-white">Jabatan</label>
                            <input type="text"
                                class="form-control
                           block
                           w-full
                           ...
                           m-0
                           focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                id="jabatan" name="jabatan" placeholder="nama jabatan" required>
                        </div>
                    </div>
                    <div
                ...
                <div
                    ...
                    <form action="/karyawan/{{ $data->id }}" method="POST">
                        ...
                        <div class="modal-body relative p-4">
                           ...
                           m-0
                           focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                    id="nama" name="nama" placeholder="nama karyawan"
                           ...
                           m-0
                           focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                    id="jabatan" name="jabatan" placeholder="nama jabatan"
